    ...
    <div style={{display: 'flex',
     flexDirection:'column',
      justifyContent:'center',
       alignItems:'center',
     gap: 20}}>
      <h1>Informacion del usuario: { usuario._id }</h1>
       ...
       <ul>
        <li>
         <strong>Nombre:</strong>   {usuario.nombre}</li>
        <li>
           <strong>Email:</strong>{usuario.email}</li>
        <li>
          <strong>Estado:</strong>{usuario.activo ? 'Es activo' : 'Es inactivo'}</li>
        <li>
          <strong>Fecha de creacion:</strong>{usuario.fechaCreacion}</li>
       </ul>
      <Link 
